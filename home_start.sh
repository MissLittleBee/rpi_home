...
for dir in ./nginx/conf.d ./nginx/cert ./volumes/nextcloud/db ./volumes/nextcloud/html ./volumes/nextcloud/data ./volumes/homeassistant/config ./volumes/plex/config ./volumes/webshare; do
    if [ ! -d "$dir" ]; then
...
echo "  3. Add media to Plex library at https://${HOSTNAME}/plex/"
